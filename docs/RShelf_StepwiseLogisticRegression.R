...
#EXP-v1 Probability: RScript<_RScriptFile="StepwiseLogisticRegression.R", _InputNames="Target, Vars", StringParam9="", BooleanParam1=TRUE>(Target, Vars)
#
#Version 2.0 Metric Expression (uses _Params for parameters):
#EXP-v2 Probability: RScript<_RScriptFile="StepwiseLogisticRegression.R", _InputNames="Target, Vars", _Params="FileName='', Stepwise=TRUE">(Target, Vars)
#
#MICROSTRATEGY_END
