...
#EXP-v1 Cluster: RScript<_RScriptFile="kMeansClustering.R", _InputNames="Vars", NumericParam1=4, NumericParam2=10, StringParam9="">(Vars)
#
#Version 2.0 Metric Expression (uses _Params for parameters):
#EXP-v2 Cluster: RScript<_RScriptFile="kMeansClustering.R", _InputNames="Vars", _Params="Exact_k=4, Max_k=10, FileName=''">(Vars)
#
#MICROSTRATEGY_END
